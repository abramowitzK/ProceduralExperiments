...
static Quaternion multiply(Quaternion l, Quaternion r) { return r * l; }
/**
Purpose: Represents the transformation of a game object. Every game object is
required to have a transform so therefore I will not make it a subclass of
Component;
*/
class Transform {
  public:
    ...
    */
    ...
    @returns A 4x4 homogenous matrix of floats in column Major order
    representing the transformation in world coordinates
    */
    ...
    */
    ...
    /**
    Sets the rotation using Euler angles. This uses a Quaternion internally.
    User facing euler angles are expected however.
