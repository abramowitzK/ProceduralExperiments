#pragma once
/**==============================================================================
 *Purose: To encapsulate the state of the keyboard (both current and
 *previous)<br> Usage: The Input class utilizes this abstraction
 */
namespace Aurora {
class KeyState {
  public:
    ...
    */
    ...
    @param code Represents the code from the standard USB keyboard codes. This
    should always use Input::Keys
    */
    ...
    */
    ...
    /**
    Copies the current values into the previous values. This will be updated
    once per frame. The previous structure will always represent the KeyState of
