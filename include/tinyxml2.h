...
template <int ITEM_SIZE> class MemPoolT : public MemPool {
  public:
    ...
    // machine. The test file is large, 170k. Release:		VS2010 gcc(no
    // opt)
    //		1k:		4000
    //		2k:		4000
    //		4k:		3900	21000
...
you return false, <b>no children of this node or its siblings</b> will be
visited.
...
class TINYXML2_LIB XMLNode {
  ...
  public:
    ...
    */
    ...
    node in the XML tree will be conditionally visited and the host will be
    called back via the XMLVisitor interface.
...
It is the same in all regards, except for the 'const' qualifiers. See XMLHandle
for API.
*/
