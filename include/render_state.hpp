...
namespace Aurora {
enum class BlendState : bool { On = true, Off = false };
...
enum class CullState { On = true, Off = false };
enum class DepthState { On = true, Off = false };
...
enum class FrontFace : GLenum { Ccw = GL_CCW, Cw = GL_CW };
